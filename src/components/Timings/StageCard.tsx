...
const StageCard: React.FC<StageCardProps> = ({
  ...
  const [editingName, setEditingName] = useState(stage.stageName === 'New Stage');
            ...
            <div className="flex-1 min-w-0 pl-6">
              {stage.completed ? (
                ...
                <input
                  ...
                  onChange={e => onStageNameChange && onStageNameChange(e.target.value)}
                ...
                <h3 className="font-medium text-lg text-bread-brown-800 cursor-pointer" onClick={() => setEditingName(true)}>
                  {stage.stageName}
                </h3>
              )}
            </div>
